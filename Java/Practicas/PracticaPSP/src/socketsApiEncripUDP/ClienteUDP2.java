...
public class ClienteUDP2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Creamos una instancia del servidor http, pasándole por parámetro un InetSocketAddress con el puerto 'localhost:8081'
		...
		context.setHandler(ClienteUDP2::respuestaManejador);
	...
	private static void respuestaManejador(HttpExchange exchange) throws IOException{
		...
		respuestaBuilder.append("TIEMPO EN LAS CIUDADES INTRODUCIDAS POR EL CLIENTE 2: ");
