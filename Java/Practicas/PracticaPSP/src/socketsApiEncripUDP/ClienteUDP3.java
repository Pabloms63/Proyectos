...
public class ClienteUDP3 {
    ...
    private static String mensajeDesencrip = "";
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Creamos una instancia del servidor http, pasándole por parámetro un InetSocketAddress con el puerto 'localhost:8082'
		...
		context.setHandler(ClienteUDP3::respuestaManejador);
        ...
        try {
            ...
            while (true) {  
                ...
                //Lo desencriptamos
                mensajeDesencrip = desencriptar(CLAVE_SERVIDOR, new byte[16], respuestaTiempo);
	...
	private static void respuestaManejador(HttpExchange exchange) throws IOException{
		...
		respuestaBuilder.append("TIEMPO EN LAS CIUDADES INTRODUCIDAS POR EL CLIENTE 3: ");
